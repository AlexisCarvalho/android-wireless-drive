...
import dev.alexis.wirelessdrive.data.AuthResponse
import dev.alexis.wirelessdrive.data.GenerateThumbnailResponse
import dev.alexis.wirelessdrive.data.GenericResponse
import dev.alexis.wirelessdrive.data.LoginRequest
import dev.alexis.wirelessdrive.data.Media
import dev.alexis.wirelessdrive.data.MediaListResponse
import dev.alexis.wirelessdrive.data.MissingThumbnailsResponse
import dev.alexis.wirelessdrive.data.RegisterRequest
import dev.alexis.wirelessdrive.data.StreamUrlResponse
import dev.alexis.wirelessdrive.data.UpdateMediaRequest
